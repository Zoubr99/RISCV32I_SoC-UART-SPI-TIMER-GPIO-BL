...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { SW[0] }]; #IO_L9P_T1_DQS_14 Sch=btnc
...
#set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { chip_select }]; #IO_L18N_T2_A23_15 Sch=ja[4]
...
set_property -dict {PACKAGE_PIN H14 IOSTANDARD LVCMOS33} [get_ports acl_miso]; #IO_L15P_T2_DQS_15 Sch=jb[4]
